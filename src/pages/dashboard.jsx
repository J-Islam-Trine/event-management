...
{
    return(
        <div className="my-8 px-16 flex-col">
            <div>
                <p className="text-3xl ">Dashboard</p>
            </div>
            <div className="bg-base-200 border-black px-8 py-4">
  ...
  <hr className="bg-primary"/>
    ...
    <div className="timeline-end timeline-box">Requirement Gathering</div>
    <hr className="bg-primary"/>
  </li>
  <li>
    <hr className="bg-primary"/>
  ...
  <li>
    <hr/>
    <div className="timeline-start timeline-box">Arrangement and Assignment</div>
    <div className="timeline-middle">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
    </div>
  </li>
  ...
  <div className="stat bg-primary text-black">
    <div className="stat-title text-xl font-semibold">Amount of money spent so far</div>
...
<div className="stats shadow">
  ...
  <div className="stat bg-primary text-black">
    <div className="stat-title text-xl font-semibold">Total Orders so far</div>
...
<div className="stats shadow">
  ...
  <div className="stat bg-primary text-black">
    <div className="stat-title text-xl">Total Number of attendees(All time)</div>
